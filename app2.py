...
def predict():
    ...
    print(result)
     ...
     # Assign class based on prediction
    if "No ripening" in result:
        prediction_class = "red"
    elif "Ripening" in result:
        prediction_class = "green"
    else:
        prediction_class = "orange"  # For any other cases

    return render_template("result.html", prediction_message=result, prediction_class=prediction_class)
